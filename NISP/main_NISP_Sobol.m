...
probabilityInfo.name=cell(numRandomVariables,1);
probabilityInfo.supp=cell(numRandomVariables,1);
probabilityInfo.pars=cell(numRandomVariables,1);

% 1st random variable (this can be understood as fc after normalization):
rv=1;
probabilityInfo.name{rv}='Normal'; % options: Uniform, Beta, Normal
...
fact=getStructuralResponse(probabilityInfo);
...
% ----------------------------------------------------------------------------------------------------------------------
% SOBOL: Preprocessing (simplifying notation of pdf and supp):
% ----------------------------------------------------------------------------------------------------------------------
